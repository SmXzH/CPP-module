...
Scalar::Scalar(){
    std::cout << "[Scalar] Constructor was called" << std::endl;
}

Scalar::~Scalar (){
    std::cout << RESET << "[Scalar] Distructor was called" << std::endl;
}

Scalar::Scalar(const Scalar & src){
    std::cout << "[Scalar] Copy construcor was called" << std::endl;
    *this = src;
}
...
Scalar::Scalar(std::string arg): _dot(0), _count(0), _fl(0), _arg(arg){
    std::cout << "[Scalar] String constructor was called" << CYAN << std::endl;
}
...
int Scalar::isAlNum(std::string _arg)
{
    while (_arg[_count])
    {
